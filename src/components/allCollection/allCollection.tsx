    ...
    <div>
      <div className="border-b border-gray-800">
        <div className="flex justify-between py-4 px-4">
          <div>
            <p className="uppercase">AllCollections</p>
          </div>
          <div className="flex gap-8 items-center text-end">
            <div>
              <p className="text-gray-400 text-sm">LISTED</p>
              <p>1 / 1</p>
            </div>
            <div>
              <p className="text-sm">EST VALUE</p>
              <p>0.4899</p>
            </div>
            <div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-5">
            ...
            >
              ...
              <p className={` ${itemsTable && "text-yellow-300"}`}>INVENTORY</p>
            </button>
            <button
              onClick={() => {
                setItemsTable(false)
            ...
            >
              ...
              <p className={` ${holders && "text-yellow-300"}`}>HISTORY</p>
            </button>
          </div>
