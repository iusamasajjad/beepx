  ...
  return (
    <div className="border border-gray-800 py-3">
      <div className="flex border-b border-gray-800 gap-4">
        <p className="text-yellow-300 border-b px-3 border-yellow-400">Mint</p>
        <p className="px-3">Project</p>
      </div>
      ...
      <div className="py-3 border border-gray-800 mx-3 px-3 my-5">
        ...
        <Button className="rounded w-full my-2" disabled >SOLD OUT</Button>
      </div>
      <div className="py-3 border border-gray-800 mx-3 px-3 my-5">
        <p>Waitlist</p>
        <div className="text-center">
